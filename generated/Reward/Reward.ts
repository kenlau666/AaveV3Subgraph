...
export class Reward__claimAllRewardsResult {
...
export class Reward__claimAllRewardsOnBehalfResult {
  value0: Array<Address>;
  value1: Array<BigInt>;
...
export class Reward__claimAllRewardsToSelfResult {
  value0: Array<Address>;
  value1: Array<BigInt>;
...
export class Reward__getAllUserRewardsResult {
  value0: Array<Address>;
  value1: Array<BigInt>;
...
export class Reward__getAssetIndexResult {
  value0: BigInt;
  value1: BigInt;
...
export class Reward__getRewardsDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Reward extends ethereum.SmartContract {
  ...
  claimAllRewards(
    ...
    return new Reward__claimAllRewardsResult(
  ...
  try_claimAllRewards(
    assets: Array<Address>,
    to: Address
  ): ethereum.CallResult<Reward__claimAllRewardsResult> {
    let result = super.tryCall(
      "claimAllRewards",
      "claimAllRewards(address[],address):(address[],uint256[])",
      [ethereum.Value.fromAddressArray(assets), ethereum.Value.fromAddress(to)]
    ...
    return ethereum.CallResult.fromValue(
      new Reward__claimAllRewardsResult(
  ...
  claimAllRewardsOnBehalf(
    ...
    user: Address,
    to: Address
  ): Reward__claimAllRewardsOnBehalfResult {
    let result = super.call(
      "claimAllRewardsOnBehalf",
    ...
    return new Reward__claimAllRewardsOnBehalfResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_claimAllRewardsOnBehalf(
    ...
    user: Address,
    to: Address
  ): ethereum.CallResult<Reward__claimAllRewardsOnBehalfResult> {
    let result = super.tryCall(
      "claimAllRewardsOnBehalf",
      "claimAllRewardsOnBehalf(address[],address,address):(address[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Reward__claimAllRewardsOnBehalfResult(
        value[0].toAddressArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  claimAllRewardsToSelf(
    assets: Array<Address>
  ): Reward__claimAllRewardsToSelfResult {
    let result = super.call(
      "claimAllRewardsToSelf",
    ...
    return new Reward__claimAllRewardsToSelfResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_claimAllRewardsToSelf(
    assets: Array<Address>
  ): ethereum.CallResult<Reward__claimAllRewardsToSelfResult> {
    let result = super.tryCall(
      "claimAllRewardsToSelf",
      "claimAllRewardsToSelf(address[]):(address[],uint256[])",
      [ethereum.Value.fromAddressArray(assets)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Reward__claimAllRewardsToSelfResult(
        value[0].toAddressArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  getAllUserRewards(
    assets: Array<Address>,
    user: Address
  ): Reward__getAllUserRewardsResult {
    let result = super.call(
      "getAllUserRewards",
    ...
    return new Reward__getAllUserRewardsResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_getAllUserRewards(
    assets: Array<Address>,
    user: Address
  ): ethereum.CallResult<Reward__getAllUserRewardsResult> {
    let result = super.tryCall(
      "getAllUserRewards",
      "getAllUserRewards(address[],address):(address[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Reward__getAllUserRewardsResult(
        value[0].toAddressArray(),
        value[1].toBigIntArray()
      )
    );
  ...
  getAssetIndex(asset: Address, reward: Address): Reward__getAssetIndexResult {
    let result = super.call(
      "getAssetIndex",
      "getAssetIndex(address,address):(uint256,uint256)",
      [ethereum.Value.fromAddress(asset), ethereum.Value.fromAddress(reward)]
    );

    return new Reward__getAssetIndexResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getAssetIndex(
    asset: Address,
    reward: Address
  ): ethereum.CallResult<Reward__getAssetIndexResult> {
    let result = super.tryCall(
      "getAssetIndex",
      "getAssetIndex(address,address):(uint256,uint256)",
      [ethereum.Value.fromAddress(asset), ethereum.Value.fromAddress(reward)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Reward__getAssetIndexResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getRewardsData(
    ...
    return new Reward__getRewardsDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getRewardsData(
    asset: Address,
    reward: Address
  ): ethereum.CallResult<Reward__getRewardsDataResult> {
    let result = super.tryCall(
      "getRewardsData",
      "getRewardsData(address,address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(asset), ethereum.Value.fromAddress(reward)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Reward__getRewardsDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
